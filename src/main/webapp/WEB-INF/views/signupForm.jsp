                  ...
                  <div class="d-flex mb-5 align-items-center" id="agree">
                    ...
                    <div class="control__indicator"></div>
                  	...
                  	<div id="agreeForm" tabindex="0">
						...
						<br/>
						<br/>						
						<b style="font-size: 12px; color: #007dcd;">
						...
						<br/>
						<br/>
						1. 먹생먹사는 회원의 개인 신상 정보를 본인의 승낙없이 타인에게 누설, 배포하지 않습니다. 단, 전기통신관련법령 등 관계법령에 의하여 관계 국가기관 등의 요구가 있는 경우에는 그러하지 아니합니다.
						<br/>
						2. 먹생먹사는 법령과 본 약관이 금지하거나 미풍양속에 반하는 행위를 하지 않으며, 지속적·안정적으로 서비스를 제공하기 위해 노력 할 의무가 있습니다.
						<br/>
						3. 먹생먹사는 이용자의 귀책사유로 인한 서비스 이용 장애에 대하여 책임을 지지 않습니다.
						<br/>
						<br/>
						제 13 조 (회원의 의무)
						<br/>
						...
						<br/>				
						<b style="font-size: 12px; color: #007dcd;">
						2. 회원은 먹생먹사의 사전 승낙없이 서비스를 이용하여 어떠한 영리행위도 할 수 없으며, 그 영업활동의 결과에 대해 먹생먹사은 일절 책임을 지지 않습니다. 또한 회원은 이와 같은 영업활동으로 먹생먹사이 손해를 입은 경우 손해배상의무를 지며, 먹생먹사은 해당 회원에 대해 서비스 이용제한 및 적법한 절차를 거쳐 손해배상 등을 청구할 수 있습니다.
						</b>
						<br/>				
						<b style="font-size: 12px; color: #007dcd;">
						3. 회원은 먹생먹사 서비스 이용과 관련하여 다음 각 호의 행위를 하여서는 안됩니다.
						</b>
						<br/>				
						...
						<br/>				
						   8) 먹생먹사의 승인을 받지 아니한 광고, 판촉물, 스팸메일, 행운의 편지, 피라미드 조직 기타 다른 형태의 권유를 게시, 게재, 전자우편 또는 기타의 방법으로 전송하는 행위
						<br/>				
						...
						<br/>				
						   17) 본 약관을 포함하여 기타 먹생먹사이 정한 제반 규정 또는 이용 조건을 위반하는 행위
						<br/>				
						   18) 기타 관계법령에 위배되는 행위
						<br/>				
						<br/>				
						...
						<br/>				
						<br/>				
						1. 먹생먹사는 서비스 이용과 관련하여 이용자에게 발생한 손해에 대하여 먹생먹사의 중대한 과실, 고의 또는 범죄행위로 인해 발생한 손해를 제외하고 이에 대하여 책임을 부담하지 않으며, 이용자가 본 서비스에 게재한 정보, 자료, 사실의 신뢰도, 정확성 등 내용에 관하여는 책임을 지지 않습니다.
						<br/>				
						2. 먹생먹사는 서비스 이용과 관련하여 이용자에게 발생한 손해 중 이용자의 고의, 실수에 의한 손해에 대하여 책임을 부담하지 아니합니다.
						<br/>				
						3. 먹생먹사는 이용자간 또는 이용자와 제3자간에 서비스를 매개로 하여 물품거래 혹은 금전적 거래 등과 관련하여 어떠한 책임도 부담하지 아니하고, 이용자가 서비스의 이용과 관련하여 기대하는 이익에 관하여 책임을 부담하지 않습니다.
						<br/>				
						<br/>				
						제 16 조 (재판관할)
						<br/>				
						<br/>				
						<b style="font-size: 12px; color: #007dcd;">
						먹생먹사와 이용자간에 발생한 서비스 이용에 관한 분쟁에 대하여는 대한민국 법을 적용하며, 본 분쟁으로 인한 소는 민사소송법상의 관할법원에 제기합니다.
						</b>
						<br/>				
						부 칙 1. (시행일) 본 약관은 2022년 4월 11일부터 시행됩니다.
						<br/>				
                  </div>
